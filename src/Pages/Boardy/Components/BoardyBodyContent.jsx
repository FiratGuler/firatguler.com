...
import heroImage from "../Assets/boardy_mobile.png";
import { FaApple } from "react-icons/fa";

export default function BoardyBodyContent({ t }) {
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-center">
        ...
        <div className="space-y-4 md:space-y-6 text-center lg:text-left order-2 lg:order-1">
          <div className="space-y-3">
            <h2 className="text-4xl md:text-5xl lg:text-7xl font-black tracking-tighter leading-[1.1] text-boardy-secondary-text">
              {t("boardyHero.title")}{" "}
              <span className=" text-boardy-accent block lg:inline">
                {t("boardyHero.highlight")}
              </span>
            </h2>
            <p className="text-lg md:text-xl text-boardy-accent/70 leading-relaxed max-w-lg mx-auto lg:mx-0 font-bold">
              {t("boardyHero.subtitle")}
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 pt-2">
            <button
              onClick={() =>
                window.open(
                  "https://apps.apple.com/tr/app/boardy/id6739463985",
                  "_blank",
                  "noopener,noreferrer",
                )
              }
